...
class SentencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sentence" do
    assert_difference('Sentence.count') do
      post sentences_url, params: { sentence: { en: @sentence.en, jp: @sentence.jp, no: @sentence.no, voice_data: @sentence.voice_data } }
    end
  ...
  test "should update sentence" do
    patch sentence_url(@sentence), params: { sentence: { en: @sentence.en, jp: @sentence.jp, no: @sentence.no, voice_data: @sentence.voice_data } }
